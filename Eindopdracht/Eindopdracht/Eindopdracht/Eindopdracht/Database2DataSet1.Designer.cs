...
namespace Eindopdracht.Eindopdracht.Eindopdracht {
    ...
    public partial class Database2DataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeeRow AddEmployeeRow(string name, string number, System.DateTime start_date, System.DateTime birthday) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeeRow FindBynumber(string number) {
...
namespace Eindopdracht.Eindopdracht.Eindopdracht.Database2DataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([name] = @Original_name) AND ([number] = @Or" +
                "iginal_number) AND ([start_date] = @Original_start_date) AND ([birthday] = @Orig" +
                "inal_birthday))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([name], [number], [start_date], [birthday]) VALUES " +
                "(@name, @number, @start_date, @birthday);\r\nSELECT name, number, start_date, birt" +
                "hday FROM Employee WHERE (number = @number)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [name] = @name, [number] = @number, [start_date] = @start_date, [birthday] = @birthday WHERE (([name] = @Original_name) AND ([number] = @Original_number) AND ([start_date] = @Original_start_date) AND ([birthday] = @Original_birthday));
SELECT name, number, start_date, birthday FROM Employee WHERE (number = @number)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Eindopdracht.Properties.Settings.Default.Database2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT name, number, start_date, birthday FROM dbo.Employee";
        ...
        public virtual int Delete(string Original_name, string Original_number, System.DateTime Original_start_date, System.DateTime Original_birthday) {
        ...
        public virtual int Insert(string name, string number, System.DateTime start_date, System.DateTime birthday) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string number, System.DateTime start_date, System.DateTime birthday, string Original_name, string Original_number, System.DateTime Original_start_date, System.DateTime Original_birthday) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, System.DateTime start_date, System.DateTime birthday, string Original_name, string Original_number, System.DateTime Original_start_date, System.DateTime Original_birthday) {
            return this.Update(name, Original_number, start_date, birthday, Original_name, Original_number, Original_start_date, Original_birthday);
        }
    }
